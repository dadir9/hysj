...
const REGION_TO_CALLING_CODE: Record<string, string> = {
  ...
  GU:'1671',GT:'502',GN:'224',GW:'245',GY:'592',HT:'509',HN:'504',HK:'852',
  HU:'36',IS:'354',IN:'91',ID:'62',IR:'98',IQ:'964',IE:'353',IL:'972',
  IT:'39',JM:'1876',JP:'81',JO:'962',KZ:'7',KE:'254',KI:'686',KP:'850',
  KR:'82',KW:'965',KG:'996',LA:'856',LV:'371',LB:'961',LS:'266',LR:'231',
  LY:'218',LI:'423',LT:'370',LU:'352',MO:'853',MK:'389',MG:'261',MW:'265',
  MY:'60',MV:'960',ML:'223',MT:'356',MH:'692',MQ:'596',MR:'222',MU:'230',
  ...
  PL:'48',PT:'351',PR:'1787',QA:'974',RE:'262',RO:'40',RU:'7',RW:'250',
  SH:'290',KN:'1869',LC:'1758',PM:'508',VC:'1784',WS:'685',SM:'378',
  ...
  UY:'598',UZ:'998',VU:'678',VE:'58',VN:'84',VG:'1284',VI:'1340',YE:'967',
  ZM:'260',ZW:'263',
};

export type CountryCode = keyof typeof REGION_TO_CALLING_CODE;

export function getDeviceCountry(): { countryCode: CountryCode; callingCode: string } {
  const locales = Localization.getLocales();
  const region = ((locales?.[0]?.regionCode) ?? 'NO').toUpperCase();
  const callingCode = REGION_TO_CALLING_CODE[region] ?? '47';
  return {
